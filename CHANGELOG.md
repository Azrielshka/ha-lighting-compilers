...
- **`scripts/generate_lovelace_cards.py`** — карточки Lovelace, у каждого
  ...
  офлайновый, в Build All не входит — вставка в дашборд вручную.
...
- **Тесты** — 345, включая приёмочные на реальной фикстуре и проверку
...
Не переехал генератор карточек Lovelace (ждёт новые шаблоны).
